        ...
        <div class="bs-scaler">
          <div class="bs-stage">
            <div class="bs-prop bs-plate" style="bottom: 60px; width: 470px; left: 50%">
              <img :src="'https://cdn.jsdelivr.net/gh/tiagocarvalhoUx/cardapio-hambuguer@master/public/assets/burger/prato.webp'" alt="" aria-hidden="true" />
            </div>
            ...
            >
              <img
                :src="'https://cdn.jsdelivr.net/gh/tiagocarvalhoUx/cardapio-hambuguer@master/public/assets/burger/' + camada.arquivo + '.webp'"
                :alt="camada.nome + ' — ' + camada.descricao"
              />
            </div>

            <div class="bs-prop bs-fries" style="bottom: 84px; width: 190px; left: calc(50% + 232px)">
              <img :src="'https://cdn.jsdelivr.net/gh/tiagocarvalhoUx/cardapio-hambuguer@master/public/assets/burger/batata.webp'" alt="Porção de batata frita" />
            </div>
            <div class="bs-prop bs-juice" style="bottom: 70px; width: 140px; left: calc(50% - 232px)">
              <img :src="'https://cdn.jsdelivr.net/gh/tiagocarvalhoUx/cardapio-hambuguer@master/public/assets/burger/suco.webp'" alt="Copo de suco" />
            </div>
