        ...
        <div class="bs-scaler">
          <div class="bs-stage">
            <div class="bs-prop bs-plate" style="bottom: 60px; width: 470px; left: 50%">
              <img :src="asset('/assets/burger/prato.webp')" alt="" aria-hidden="true" />
            </div>
